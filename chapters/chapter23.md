...
日均值 = -0.0382%,  日波动率 = 1.4371%
年化波动率 = 22.81%   (sqrt(252) 法则)
滞后1阶自相关 = +0.0520, Ljung-Box Q(10) p值 = 0.0001
-> 自相关统计上显著, 但幅度很小(滞后1阶仅+5%): 随机游走是好的第一近似, 却非严格成立
超额峰度 = 7.95  (正态分布为 0; 远大于 0 => 厚尾)

=== sqrt(k) 缩放检验: k日收益率的波动率 ===
  k(天) |      实际std |   sqrt(k)x日std |      比值
       1 |     0.014371 |         0.014371 |    1.0000
       2 |     0.020849 |         0.020323 |    1.0258
       5 |     0.034591 |         0.032134 |    1.0765
      10 |     0.055764 |         0.045444 |    1.2271
      20 |     0.063372 |         0.064268 |    0.9861

|r| 序列的 Ljung-Box Q(10) p值 = 1.11e-22
...
3. **厚尾严重**: 超额峰度 7.95, 远超正态的 0。用正态假设管理极端风险会系统性地掉以轻心——第11章多重检验的教训在此同样适用。
