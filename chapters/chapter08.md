...
样本量: 723 个交易日
均值(日):   -0.000245  (-6.19% 年化)
标准差(日): 0.014309  (22.71% 年化)
偏度:       1.0597  (右偏/正偏)
超额峰度:   7.9942  (厚尾!)
正态分布峰度基准: 3.0 (超额峰度 = 0)
```
...
正态性检验
=======================================================
Jarque-Bera 检验: 统计量 = 2060.5, p-value = 0.00e+00
  -> 拒绝正态假设(p<0.05)
Kolmogorov-Smirnov 检验: 统计量 = 0.1141, p-value = 1.19e-08
  -> 拒绝正态假设(p<0.05)

        事件 |       实际频率 |       正态预测 |       倍数
--------------------------------------------------
2sigma 事件 |     0.0498 |     0.0455 |     1.1x
3sigma 事件 |     0.0152 |     0.0027 |     5.6x
4sigma 事件 |     0.0111 |     0.0001 |   174.7x

t 分布拟合结果: nu(自由度) = 2.37, loc = -0.001068, scale = 0.007759
解读: nu = 2.4 意味着方差 ≈ 6.4*scale^2 (当 nu>2 时)
      隐含日方差 = 0.00038822, 隐含日波动率 = 1.9703%
```
...
贵州茅台   723  -6.19  22.71  1.06   7.99  2.37  174.69
宁德时代   723  23.52  38.57  0.73   8.67  3.05  152.85
