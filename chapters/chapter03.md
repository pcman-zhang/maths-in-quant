...
--------------------------------------------------------------------------------
  -2.00% |   108.1113 |   108.6590 |   108.1083 |     0.547721 |     0.002964
  -1.00% |   104.0554 |   104.3295 |   104.0550 |     0.274126 |     0.000371
  -0.50% |   102.0201 |   102.1648 |   102.0201 |     0.144711 |     0.000046
   0.50% |    98.0392 |    97.8352 |    98.0392 |     0.204025 |     0.000046
   1.00% |    96.1538 |    95.6705 |    96.1539 |     0.483284 |     0.000371
   2.00% |    92.5926 |    91.3410 |    92.5931 |     1.251605 |     0.002964
```

**关键观察**：

1. **久期 = 4.33**：当收益率上升 1% 时，价格大约下跌 4.33%。这是一个非常实用的风险指标。
2. **仅久期近似在大幅波动时误差很大**：当收益率变化 ±2% 时，仅久期近似的误差超过 0.5 元（相对误差约 0.5%）。
3. **加入凸性后误差急剧缩小**：即使收益率变化 ±2%，久期+凸性近似的误差也只有约 0.003 元（相对误差约 0.003%）。
4. **凸性的不对称效应**：收益率下降时价格上升的幅度，大于收益率同等幅度上升时价格下降的幅度。这正是"凸性"名称的来源——曲线是凸的。
